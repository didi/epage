<template lang='pug'>
Tree.ep-widget-cascader-datatree(:data="rootList" :render="renderContent")
</template>
<script>
...
export default {
    ...
    return {
      rootList: [{
        ...
        render: (h, { root, node, data }) => {
          return <div class="ep-widget-cascader-datatree-root">
  ...
  methods: {
    renderContent (h, { root, node, data }) {
      ...
      return (
        <div class="ep-widget-cascader-datatree-item">
          <div class="ep-widget-cascader-datatree-content">
            {list.map(item => {
              return (
                <div>
                  <span class="mr5">
                  ...
                  <i-input
                    ...
                    class={{
                      'ep-widget-cascader-datatree-content-input': true,
          ...
          <div class="ep-widget-cascader-datatree-operat">
            <i-button
              class="mr5"
              type="ghost"
              size="small"
